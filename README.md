...
fft_check.F is in https://github.com/t-nissie/fft_check .
...
Double-precision real-complex 3-dimensional in-place FFT is performed
...
* SMT off (SMT: Simultaneous Multithreading)
* FFTW planner flag: FFTW_PATIENT
* SC queue in CCMS-IMR is used. Core-binding is not available.
* Environment variables: `XLSMPOPTS="spins=0:yields=0"`
...
Copying and author
------------------
Copyright (c) 2007-2015 by Takeshi Nishimatsu
